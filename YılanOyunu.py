...
class duvar():
    ...
    def draw(self,screen):
        self.image = pygame.image.load("images/gri3.png")
        self.image = pygame.transform.scale(self.image, (self.rectangle[2], self.rectangle[3]))
        self.image2 = pygame.image.load("images/gri3.png")
...
class yilan():
    ...
    def draw(self,mx,my,screen):
        ...
        if gameDuvar.rectangle.contains(self.rectangle) \
                or gameDuvar.rectangle2.contains(self.rectangle):
    ...
    def eat(self):
        if (gameYilan.yilanX >= gamePlaneApple.rectangle[0] and gameYilan.yilanX <= (gamePlaneApple.rectangle[0])+gamePlaneApple.rectangle[2]
            ...
            if gamePlaneApple2.secilen== gamePlaneApple.elmalar[0]:
                if self.yilanLength==0:
                    gameYilan.crashed = gameOverMenu.runExitMenu(gameDisplay)

                self.yilanLength -= 1
            elif gamePlaneApple2.secilen== gamePlaneApple.elmalar[1]:
                    self.yilanLength += 3
            elif gamePlaneApple2.secilen== gamePlaneApple.elmalar[2]:
                gameYilan.bes=6
                gameYilan.ekran=100


            elif gamePlaneApple2.secilen== gamePlaneApple.elmalar[3]:
                gameYilan.crashed = gameOverMenu.runExitMenu(gameDisplay)

            elif gamePlaneApple2.secilen== gamePlaneApple.elmalar[4]:
                gameYilan.bes=4
                gameYilan.ekran=4


            gamePlaneApple2.randomElma()

        for kare in gameYilan.yilanUzunlugu[:-1]:
...
class elma():
    ...
    def __init__(self,screen):
        ...
        self.elma2X = round(random.randrange(50, width -80))
...
def mesaj(screen,skor):
    ...
    gameYilan.puan=skor
    screen.blit(text, [screen.get_width()/2,0])
